...
--
-- Host: localhost
-- Generation Time: Jun 28, 2018 at 08:58 PM
...
INSERT INTO `account` (`id`, `admission`, `tution`, `food`, `transportation`, `extra`, `total`, `discount`, `studentId`, `datetime`) VALUES
(1, 10000, 4000, 4000, 4000, 4000, 4000, 10, 10, '2018-06-27 10:28:55'),
(3, 0, 100, 100, 100, 100, 400, 0, 10, '2018-06-28 18:52:29');
...
INSERT INTO `account_status` (`id`, `studentId`, `status`, `balance`) VALUES
(1, 10, 0, 0);
...
(10, 'Irajan Dhakal', 'Ramhari Dhakal', 'Indra Dhakal', '2018-10-31', 'U.K.G.', '2018-05-28', '5/3', 'M', 'Chasyal,La', 'Chasyal,Lalitpur', 'Harmi', NULL, 1, '', '', 0),
